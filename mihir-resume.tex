...
\begin{minipage}[t]{0.69\textwidth} % The left column takes up 33% of the text width of the page
\hspace{49pt}
...
\runsubsection{HTCondor}
\descript{| Student Intern}

\location{September 2015 – Till Date | Madison, Wisconsin}
...
\runsubsection{BITS - Pilani, Goa Campus}
\descript{| Professional Assistant}

\location{January 2010 – May 2010 | Goa, India}
\begin{tightitemize}
